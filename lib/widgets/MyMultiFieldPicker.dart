...
class MyMultiFieldPicker<T> extends StatefulWidget {
  ...
  @override
  State<MyMultiFieldPicker<T>> createState() => _MyMultiFieldPickerState<T>();
}

class _MyMultiFieldPickerState<T> extends State<MyMultiFieldPicker<T>> {
