...
class ProfileViewDesktop extends ConsumerStatefulWidget {
  static ProfileController myProfileController = getIt<ProfileController>();

  const ProfileViewDesktop({super.key});

  @override
  ConsumerState<ProfileViewDesktop> createState() => _ProfileViewDesktopState();
}

class _ProfileViewDesktopState extends ConsumerState<ProfileViewDesktop> {
  static ProfileController myProfileController = getIt<ProfileController>();
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Expanded(child: MyExpansionTile(
