...
class AddUserViewDesktop extends StatefulWidget {
  static AddUserController myAddUserController = getIt<AddUserController>();

  const AddUserViewDesktop({super.key});

  @override
  State<AddUserViewDesktop> createState() => _AddUserViewDesktopState();
}

class _AddUserViewDesktopState extends State<AddUserViewDesktop> {
  static AddUserController myAddUserController = getIt<AddUserController>();
                        ...
                        children: [
                          GridView(
                            ...
                            gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                                ...
                                crossAxisCount: 4,childAspectRatio: 8,mainAxisSpacing: 4,crossAxisSpacing: 12),
                            children: BasicClass.constData.data.attribute.where((a) => a.onlyOwner).map((att) {
                              ...
                              if (att.type == "string") {
                                return Padding(
                                  ...
                                  child: MyTextFieldNew(required: att.mandatory, rowLabelRatio: [4, 5], headerBgColor: headerBg, bodyBgColor: bodyBg, label: att.title, placeholder: att.title, controller: attributes[att.name]),
                                );
