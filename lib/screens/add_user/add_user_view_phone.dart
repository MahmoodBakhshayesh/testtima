...
class _AddUserViewPhoneState extends State<AddUserViewPhone> {
  ...
  addUser() async {
    // await myAddUserController.addUser(username: usernameC.text, email: emailC.text, password: passwordC.text, firstname: firstNameC.text, lastname: lastNameC.text, permissions: includedPermissions
    //
    // );
  }
