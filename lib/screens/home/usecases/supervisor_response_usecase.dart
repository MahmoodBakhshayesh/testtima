...
class SupervisorResponseResponse extends ResponseInterface {
  ...
  SupervisorResponseResponse({required super.status, required super.message, required this.msg}) : super(body: {});

  factory SupervisorResponseResponse.fromResponse(ResponseInterface res) => SupervisorResponseResponse(status: res.status, message: res.message, msg: res.message);
}
