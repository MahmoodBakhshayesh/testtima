...
class PassportWidget extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return MyExpansionTile(
      ...
      title: Column(
        children: [
          Row(
            ...
            children: [
              Expanded(
                child: Text("Passport", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
              ),
              DotButton(
                ...
                onPressed: () async {
                  ...
                  if (!confirm) return;
                  ref.read(passportsProvider.notifier).removeAt(ref.read(passportsProvider).length - 1);
                },
                size: 40,
                radius: 8,
                iconSize: 20,
      ...
      showFooter: false,
      backgroundColor: Color(0xffE2E7F5),
      collapsedBackgroundColor:Color(0xffE2E7F5),
