...
class _ConfirmOfflineScannedDocDialogState extends ConsumerState<ConfirmOfflineScannedDocDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final expiringColor = Color(0xffffb84e);
    final expiringTextColor = Color(0xff7a4700);
    return Material(
      child: Container(
            ...
            ?(isExpired || isExpiring)
                ? Container(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        IcomoonLayeredCss.warning_2(colors: [isExpiring ? expiringTextColor :Colors.white,Colors.white,Colors.white]),
                        const SizedBox(width: 8),
                        Text(
                          "${expiryValidator("", documentDetail.documentExpiryDate)}",
                          style: TextStyle(color: isExpiring ? expiringTextColor : Colors.white, fontSize: 25, fontWeight: FontWeight.bold),
                        ),
                      ],
                    ),
                  )
          ...
          child: Column(
            children: [
              Row(
                ...
                children: [
                  Expanded(
                    child: CheckedValueWidget(
                      verified: docNoVerified,
...
class CheckedValueWidget extends StatelessWidget {
  final Widget child;
  final bool verified;
  const CheckedValueWidget({super.key, required this.child, required this.verified});
