import 'package:abds/core/utils_and_services/recorder/my_player_widget.dart';
...
class MyAudioPlayerWidget extends StatefulWidget {
  ...
  /// Creates a new instance of the [MyAudioPlayerWidget] widget.

  const MyAudioPlayerWidget({
    super.key,
    this.controller,
    this.autoLoad = true,
    this.autoPlay = false,
  ...
  @override
  State<MyAudioPlayerWidget> createState() => _MyAudioPlayerWidgetState();
}
