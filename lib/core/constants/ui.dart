...
class MyTheme {
  ...
  static ThemeData lightAbomis(BuildContext con) => ThemeData(
    ...
    tabBarTheme: TabBarThemeData(labelPadding: EdgeInsets.zero, labelColor: Colors.blue, unselectedLabelColor: Colors.blue.withOpacity(0.5)),
...
class Styles {
  ...
  static InputDecoration dropDownStyle = InputDecoration(
      contentPadding: EdgeInsets.only(left: 16, top: 2, bottom: 1),
      labelStyle: TextStyle(fontSize: 12),
      border: OutlineInputBorder(
        borderRadius: BorderRadius.circular(5),
        borderSide: BorderSide(width: 1, color: MyColors.veryLightPink2),
      ),
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(5),
        borderSide: BorderSide(width: 1, color: MyColors.lightIshBlue),
      ),
  ...
  static InputDecoration dropDownStyleRequired = InputDecoration(
      labelStyle: TextStyle(color: MyColors.darkMint),
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(5),
        borderSide: BorderSide(width: 1, color: MyColors.darkMint),
      ),
      enabledBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(5),
        borderSide: BorderSide(width: 1, color: MyColors.darkMint),
  ...
  static InputDecoration textFieldStyleInvalid = InputDecoration(
      labelStyle: TextStyle(color: MyColors.red),
      contentPadding: EdgeInsets.symmetric(horizontal: 16, vertical: 2),
      border: OutlineInputBorder(
        borderRadius: BorderRadius.circular(5),
  ...
  static InputDecoration textFieldStyleConfirmed = InputDecoration(
      suffixIcon: Icon(
        Icons.check,
        size: 20,
  ...
  static InputDecoration textFieldStyleRequired = InputDecoration(
      labelStyle: TextStyle(color: MyColors.darkMint),
      contentPadding: EdgeInsets.symmetric(horizontal: 16, vertical: 2),
      border: OutlineInputBorder(
        borderRadius: BorderRadius.circular(5),
